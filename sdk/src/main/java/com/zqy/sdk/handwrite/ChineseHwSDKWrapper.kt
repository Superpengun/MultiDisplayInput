 ...
 * @package:com.zqy.sdk.handwrite
 */
class ChineseHwSDKWrapper : HandWriteSDKWrapper {
    private val TAG: String = ChineseHwSDKWrapper::class.java.getSimpleName()
    ...
    override fun init(): Boolean {
        ...
        mHwrConfig.addParam(
            ...
            Constants.HWRConstant.RES_PREFIX_CH
        )
        ...
        //手写识别范围,GB+数字英文字母标点符号的识别
        val recogRange = Constants.HWRConstant.RECOG_RANGE_GBK + "+all"
        //手写识别范围
        mHwrConfig.addParam(HwrConfig.ResultConfig.PARAM_KEY_RECOG_RANGE, recogRange)
