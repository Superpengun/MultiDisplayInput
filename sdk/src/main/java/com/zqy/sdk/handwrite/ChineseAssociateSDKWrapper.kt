 ...
 * @package:com.zqy.sdk.handwrite
 */
class ChineseAssociateSDKWrapper :AssociateSDKWrapper{
    private val TAG: String = ChineseAssociateSDKWrapper::class.java.getSimpleName()
    ...
    override fun raisePriority(word: String?) {
        val result = HciCloudHwr.hciHwrAssociateWordsAdjust(mAssociateSession, null, word)
        Log.i(TAG, "advanceAssociateWord result = $result")
    }
}